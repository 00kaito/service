...
public class MongodbContainer {
    ...
    public static final GenericContainer<?> MONGO_DB_CONTAINER = new GenericContainer<>(
            DockerImageName.parse("mongo:7.0.0"))
            .withExposedPorts(27017)
            .withCopyFileToContainer(MountableFile.forClasspathResource("mongodb-init/cycle"), "/data/dump")
            .withCommand("mongorestore --db test_db --drop /data/dump/test_db");
